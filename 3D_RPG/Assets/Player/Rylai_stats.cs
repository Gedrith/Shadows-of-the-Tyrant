...
public class Rylai_stats {

	//default stats
	private static int str = 24; // Strength 
	private static int dex = 39; // Dexterity
	private static int con = 26; // Constitution
	private static int intel = 53; // Intellegence 
	private static int speed = 40; // Speed
	private static int HP = 50; // Max HP = Con + str
	public static int current_HP = 50; // Current HP
	public static int MP = 53;
	public static int current_MP = 53;
