...
public class Luna_stats {

	//default stats
	private static int str = 30; // Strength 
	private static int dex = 51; // Dexterity
	private static int con = 26; // Constitution
	private static int intel = 32; // Intellegence 
	private static int speed = 44; // Speed
	private static int HP = 56; // Max HP = Con + str
	public static int current_HP = 56; // Current HP
	public static int MP = 0;
	public static int current_MP = 0;
